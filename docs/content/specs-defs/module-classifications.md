...
- Bicep: `utl/<hyphenated grouping/category name>/<hyphenated utility module name>`. Modules will be kept under the `utl` folder in the BRM repository.
- Terraform: `utl-<utility-module-name>`. Repositories will be named after the utility module (e.g., `terraform-azurerm-avm-utl-<my utility module>`).
